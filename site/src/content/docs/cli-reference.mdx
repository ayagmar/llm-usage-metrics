...
| `--source` | - | `<name>` | Filter by source id \(repeatable or comma-separated, supported sources \(12\): pi, codex, gemini, droid, opencode, openclaw, claude, copilot, goose, amp, qwen, kimi\) |
