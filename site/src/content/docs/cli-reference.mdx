...
| `--source` | - | `<name>` | Filter by source id \(repeatable or comma-separated, supported sources \(11\): pi, codex, gemini, droid, opencode, openclaw, claude, copilot, goose, amp, qwen\) |
