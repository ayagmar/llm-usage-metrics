...
`llm-usage-metrics` uses a JSON config file for persistent defaults. CLI flags still work for one-off runs, and environment variables remain available as an override layer for scripts, CI, and debugging.
