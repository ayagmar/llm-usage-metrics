...
- `--source-dir` supports directory-backed sources (`pi`, `codex`, `gemini`, `droid`, `copilot-cli`, `copilot-vscode`).
...
llm-usage monthly --source pi,codex,copilot-cli,copilot-vscode
