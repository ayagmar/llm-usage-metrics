...
Welcome to the `llm-usage-metrics` documentation. This high-performance CLI tool provides deep visibility into your local AI development costs by aggregating usage across pi, codex, Gemini CLI, Droid CLI, Copilot CLI, Copilot VS Code, and OpenCode sessions.
...
<CardGrid>
  ...
  <LinkCard
    title="Data Sources"
    description="Technical details on pi, codex, Gemini CLI, Droid CLI, Copilot, and OpenCode adapters."
...
- **Universal Parsing**: Autonomously discovers and parses `.pi`, `.codex`, `.gemini`, `.factory`, `.copilot`, VS Code workspace storage, and OpenCode session data.
