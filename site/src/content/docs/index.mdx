...
Welcome to the `llm-usage-metrics` documentation. This high-performance CLI tool provides deep visibility into your local AI development costs by aggregating usage across pi, codex, Gemini CLI, Droid CLI, OpenCode, OpenClaw, Claude Code, GitHub Copilot CLI, Goose, and Amp sessions.
...
<CardGrid>
  ...
  <LinkCard
    title="Data Sources"
    description="Technical details on pi, codex, Gemini CLI, Droid CLI, OpenCode, OpenClaw, Claude Code, Copilot, Goose, and Amp adapters."
...
- **Universal Parsing**: Autonomously discovers and parses `.pi`, `.codex`, `.gemini`, `.factory`, OpenCode, OpenClaw, `.claude`, Copilot, Goose, and Amp session data.
