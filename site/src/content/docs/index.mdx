...
Welcome to the `llm-usage-metrics` documentation. This high-performance CLI tool provides deep visibility into your local AI development costs by aggregating usage across pi, codex, Gemini CLI, Droid CLI, OpenCode, OpenClaw, Claude Code, GitHub Copilot CLI, Goose, Amp, and Qwen CLI sessions.
...
<CardGrid>
  ...
  <LinkCard
    title="Data Sources"
    description="Technical details on pi, codex, Gemini CLI, Droid CLI, OpenCode, OpenClaw, Claude Code, Copilot, Goose, Amp, and Qwen adapters."
...
- **Universal Parsing**: Autonomously discovers and parses `.pi`, `.codex`, `.gemini`, `.factory`, OpenCode, OpenClaw, `.claude`, Copilot, Goose, Amp, and Qwen session data.
