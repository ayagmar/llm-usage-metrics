...
- `--source-dir` supports only `pi`, `codex`, `gemini`, `droid`, `openclaw`, `claude`, and `copilot`.
- `--pi-dir`, `--codex-dir`, `--gemini-dir`, `--droid-dir`, `--claude-dir`, and `--copilot-dir` must point to valid directories.
