...
- `--source-dir` supports only `pi`, `codex`, `gemini`, `droid`, `openclaw`, `claude`, `copilot`, `amp`, `qwen`, `kimi`, `cline`, `roocode`, and `kilocode`.
- `--pi-dir`, `--codex-dir`, `--gemini-dir`, `--droid-dir`, `--claude-dir`, `--copilot-dir`, `--amp-dir`, `--qwen-dir`, `--kimi-dir`, `--cline-dir`, `--roocode-dir`, and `--kilocode-dir` must point to valid directories.
...
llm-usage daily --pi-dir /path/to/pi --codex-dir /path/to/codex --gemini-dir /path/to/.gemini --droid-dir /path/to/.factory/sessions --claude-dir /path/to/.claude/projects --copilot-dir /path/to/.copilot/otel --amp-dir /path/to/amp/threads --qwen-dir /path/to/.qwen/projects --kimi-dir /path/to/kimi/sessions --cline-dir /path/to/cline/tasks --roocode-dir /path/to/roocode/tasks --kilocode-dir /path/to/kilocode/tasks
