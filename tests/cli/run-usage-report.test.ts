...
describe('buildUsageReport', () => {
  ...
  it('validates source and model filter input', async () => {
    ...
    await expect(
      ...
      'Unknown --source value(s): unknown-source. Allowed values: amp, antigravity, claude, cline, codex, copilot, droid, gemini, goose, kilocode, kimi, openclaw, opencode, pi, qwen, roocode',
    );
